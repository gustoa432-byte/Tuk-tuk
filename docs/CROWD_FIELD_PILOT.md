...
> **Исторический документ** эпохи TukTuk (сейчас продукт называется **Qq**). Описанный здесь экспериментальный режим не входит в продуктовый UI Qq и отключён в Core-сборке (`QQ_CORE_ONLY`). Сохранено как история.
